...
const formSubmitHandle = async function(e) {
    ...
    stamp.children[0].classList.add("check");
    const date = new Date();
    stamp.children[0].children[0].innerText = `${date.getFullYear()}-${date.getMonth()+1 < 10 ? "0"+(date.getMonth()+1) : date.getMonth()+1}-${date.getDate()}`;
};
